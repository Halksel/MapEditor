//http://naichilab.blogspot.jp/2013/11/unitycrgbhsv.html
using System;
...
namespace UnityEngine
{
	...
	public static class ColorExtension
	{
		...
		/// </summary>
		/// <returns></returns>
		public static Color ComplementaryColor(this Color c){
			float M = c.maxColorComponent + Mathf.Min(new float[]{c.r,c.g,c.b});
			c.r = M - c.r;
			c.g = M - c.g;
			c.b = M - c.b;
			return c;
